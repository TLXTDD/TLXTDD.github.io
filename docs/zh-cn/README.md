...
> ###### ▶️ [观看本节视频讲解](https://learning.dcloud.io/#/?vid=0)
...
> ###### ▶️ [观看本节视频讲解](https://learning.dcloud.io/#/?vid=1)
...
[安装教程](zh-cn/VueJs/install.md)给出了更多安装 Vue 的方式。请注意我们**不推荐**新手直接使用 `vue-cli`，尤其是在你还不熟悉基于 Node.js 的构建工具时。
...
> ###### ▶️ [观看本节视频讲解](https://learning.dcloud.io/#/?vid=3)
...
> ###### ▶️ [观看本节视频讲解](https://learning.dcloud.io/#/?vid=8)
